...
static RetroOption<CPUCore> ppsspp_cpu_core("ppsspp_cpu_core", "CPU内核", { { "动态重编译", CPUCore::JIT }, { "IR动态重编译", CPUCore::IR_JIT }, { "解释器", CPUCore::INTERPRETER } });
static RetroOption<int> ppsspp_locked_cpu_speed("ppsspp_locked_cpu_speed", "锁定CPU主频", { { "关闭", 0 }, { "222MHz", 222 }, { "266MHz", 266 }, { "333MHz", 333 } });
...
static RetroOption<int> ppsspp_rendering_mode("ppsspp_rendering_mode", "渲染模式", { { "缓冲式", FB_BUFFERED_MODE }, { "无缓冲式", FB_NON_BUFFERED_MODE } });
...
static RetroOption<int> ppsspp_audio_latency("ppsspp_audio_latency", "音频延迟", { "低", "中", "高" });
...
static RetroOption<int> ppsspp_texture_scaling_type("ppsspp_texture_scaling_type", "纹理缩放算法", { { "xbrz", TextureScalerCommon::XBRZ }, { "hybrid", TextureScalerCommon::HYBRID }, { "bicubic", TextureScalerCommon::BICUBIC }, { "hybrid_bicubic", TextureScalerCommon::HYBRID_BICUBIC } });
...
static RetroOption<bool> ppsspp_cheats("ppsspp_cheats", "内建金手指支持", false);
static RetroOption<IOTimingMethods> ppsspp_io_timing_method("ppsspp_io_timing_method", "IO时序模式", { { "快速模式", IOTimingMethods::IOTIMING_FAST }, { "主机模式", IOTimingMethods::IOTIMING_HOST }, { "模拟UMD延迟", IOTimingMethods::IOTIMING_REALISTIC } });
